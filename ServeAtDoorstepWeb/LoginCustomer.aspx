<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Serve.Master" CodeBehind="LoginCustomer.aspx.cs" Inherits="ServeAtDoorstepWeb.LoginCustomer" %>
...
<div style="border: thin solid #800080;width: 400px; height: 250px; border-radius:10px 10px 10px 10px;">
     ...
     font-family: sans-serif; font-weight: 500; font-size: large; color: #FFFFCC;vertical-align:middle;">
                                    &nbsp;&nbsp;
                                    <asp:Label ID="lblCaptionText" runat="server" Text="Customer Login" Font-Names="Verdana"></asp:Label>
                            ...
                            <tr>
                                ...
                                <td class="auto-style2">
                                    ...
                                    <br />
                                    <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" style="width:120px;" /><br />
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style3">&nbsp;</td>
                                <td class="auto-style2">
                                    <asp:HyperLink ID="hlRegAccount" runat="server" style="font-size: 18px; margin:0px 0px 0px 0px;" NavigateUrl="~/RegisterCustomer.aspx" >Register</asp:HyperLink>
                                    <br />
