                        ...
                        <tr>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="hlNewInquiry" runat="server" NavigateUrl="~/PostQuote.aspx" CssClass="DashLink" Width="120px">New Inquiry</asp:HyperLink>
                                    ...
                                    <tr style="width: 100%;">
                                        <td style="padding: 8px 8px 8px 8px;">
                                            <div style="border: thin solid black; border-radius: 7px 7px 7px 7px; padding: 10px 10px 10px 10px;">
                                                ...
                                                <asp:Label ID="Label4" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton5" runat="server" Text="Communication with vendor" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label3" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton4" runat="server" Text="Cancelled / Expired Inquiry" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label2" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="lnkLiveInquiry" runat="server" Text="Old Inquiry list" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label1" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Success.aspx" CssClass="DashLink" Width="120px">New Order</asp:HyperLink>
                                    ...
                                    <tr style="width: 100%;">
                                        <td style="padding: 8px 8px 8px 8px;">
                                            <div style="border: thin solid black; border-radius: 7px 7px 7px 7px; padding: 10px 10px 10px 10px;">
                                                <asp:LinkButton ID="LinkButton6" runat="server" Text="Order placed" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label6" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton7" runat="server" Text="Order cancelled" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label7" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton8" runat="server" Text="Order pending for acceptance" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label8" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton9" runat="server" Text="Order in process" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label9" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                                                <asp:LinkButton ID="LinkButton10" runat="server" Text="Orders completed" Height="20px"></asp:LinkButton>
                                                <asp:Label ID="Label10" runat="server" Text="(0)" Height="20px" ForeColor="#3366ff"></asp:Label><br />
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Success.aspx" CssClass="DashLink" Width="120px">New Payment</asp:HyperLink>
                        ...
                        <tr>
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Success.aspx" CssClass="DashLink" Width="120px">Initiate Pickup</asp:HyperLink>
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Success.aspx" CssClass="DashLink" Width="150px">Confirm to receive</asp:HyperLink>
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="width: 100%; height: 25px;">
                                        <td style="padding-left: 15px;">
                                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/Success.aspx" CssClass="DashLink" Width="120px">New Feedback</asp:HyperLink>
