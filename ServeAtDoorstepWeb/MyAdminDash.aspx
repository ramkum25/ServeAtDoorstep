<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAdminDash.aspx.cs" MasterPageFile="~/Serve.Master" Inherits="ServeAtDoorstepWeb.MyAdminDash" %>
                                    ...
                                    <tr style="width:100%;">
                                        <td style="padding:8px 8px 8px 8px;">
                                            <div style="border:thin solid black; border-radius:7px 7px 7px 7px; padding:10px 10px 10px 10px;">
                                                ...
                                                <asp:LinkButton ID="LinkButton4" runat="server" Text="Communication with Supplier" Height="20px"></asp:LinkButton><br />
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width:100%;">
                                    ...
                                    <tr style="width:100%;">
                                        <td style="padding:8px 8px 8px 8px;">
                                            <div style="border:thin solid black; border-radius:7px 7px 7px 7px; padding:10px 10px 10px 10px;">
                                                <asp:LinkButton ID="LinkButton18" runat="server" Text="Await Customer response to pickup" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton19" runat="server" Text="Pending pickup from Customer" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton20" runat="server" Text="Recent pickups" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton21" runat="server" Text="Await Supplier response to pickup" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton22" runat="server" Text="Pending pickup from Supplier" Height="20px"></asp:LinkButton><br />
                            ...
                            <td style="height: 200px; width: 200px;">
                                <table style="width:100%;">
                                    ...
                                    <tr style="width:100%;">
                                        <td style="padding:8px 8px 8px 8px;">
                                            <div style="border:thin solid black; border-radius:7px 7px 7px 7px; padding:10px 10px 10px 10px;">
                                                <asp:LinkButton ID="LinkButton24" runat="server" Text="Goods Await Delivery to Supplier" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton25" runat="server" Text="Goods Await Delivery to Customer" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton26" runat="server" Text="Await Supplier Acceptance to receive" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton27" runat="server" Text="Await Customer Acceptance to receive" Height="20px"></asp:LinkButton><br />
                                                <asp:LinkButton ID="LinkButton28" runat="server" Text="Receive deliveries" Height="20px"></asp:LinkButton><br />
